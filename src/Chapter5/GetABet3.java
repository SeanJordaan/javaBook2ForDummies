 ...
 * @author Sean
 */
//in this program a boolean expression is run and if the return is true then the statement will run and also run a if statement if the 
//value entered is incorrect 
//ultimatly this program runs  a boolean, do-while loop and a iff statement 
